    ...
    <div>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-6 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="flex items-end gap-4">
              {shop?.logoUrl && (
                <div className="size-16 shrink-0 overflow-hidden rounded-2xl border-2 border-background bg-background shadow-lg sm:size-20">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-2xl font-bold text-white drop-shadow-sm sm:text-3xl">
                  {isLoading ? <Skeleton className="h-8 w-48" /> : shop?.name}
                </h1>
                {shop?.description && (
      ...
      <div className="border-b border-border/50 bg-card">
        <div className="mx-auto flex max-w-7xl items-center gap-6 overflow-x-auto px-4 py-3 text-sm lg:px-8 hide-scrollbar">
          ...
          <button className="flex shrink-0 items-center gap-1 text-primary hover:underline">
      ...
      <div
        ref={categoryNavRef}
        className={cn(
          "sticky top-16 z-30 border-b border-border/50 bg-background/95 backdrop-blur-md transition-shadow",
          isSticky && "shadow-sm"
        )}
      >
        ...
        {isLoading ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex gap-4 rounded-2xl border border-border/50 p-4">
              ...
              return (
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3">
                      <PriceDisplay cents={product.priceCents} className="text-base font-semibold" />
                    </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-lg font-bold">
                  <PriceDisplay cents={totalCents()} className="text-primary-foreground" />
                </span>
