...
const DEFAULT_TITLE = "Delivio Rider";
const DEFAULT_DESCRIPTION = "Rider dashboard for Delivio deliveries";

export async function buildRiderMetadata(): Promise<Metadata> {
